        ...
        <article className="space-y-10">
          ...
          <nav className="p-6 bg-card border border-border">
            ...
            <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
              ...
              <li><a href="#definitions" className="hover:text-foreground transition-colors">Definitions</a></li>
              <li><a href="#account" className="hover:text-foreground transition-colors">Account Registration</a></li>
              <li><a href="#products" className="hover:text-foreground transition-colors">Products and Services</a></li>
              <li><a href="#free-services" className="hover:text-foreground transition-colors">Free Services and Beta Features</a></li>
              <li><a href="#acceptable-use" className="hover:text-foreground transition-colors">Acceptable Use Policy</a></li>
              <li><a href="#user-content" className="hover:text-foreground transition-colors">User Content</a></li>
              <li><a href="#ordering" className="hover:text-foreground transition-colors">Online Ordering Process</a></li>
              <li><a href="#pricing" className="hover:text-foreground transition-colors">Pricing and Payment</a></li>
              <li><a href="#subscriptions" className="hover:text-foreground transition-colors">Subscription Terms</a></li>
              <li><a href="#refunds" className="hover:text-foreground transition-colors">Refund Policy</a></li>
              <li><a href="#ip" className="hover:text-foreground transition-colors">Intellectual Property</a></li>
              <li><a href="#liability" className="hover:text-foreground transition-colors">Limitation of Liability</a></li>
              <li><a href="#indemnification" className="hover:text-foreground transition-colors">Indemnification</a></li>
              <li><a href="#termination" className="hover:text-foreground transition-colors">Termination</a></li>
              <li><a href="#governing" className="hover:text-foreground transition-colors">Governing Law</a></li>
          ...
          <section id="definitions">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2">
              <li><strong className="text-foreground">&quot;Services&quot;</strong> refers to all Helvety websites, applications, platforms, and related services.</li>
              <li><strong className="text-foreground">&quot;User,&quot; &quot;you,&quot; or &quot;your&quot;</strong> refers to any individual or entity accessing or using the Services.</li>
              <li><strong className="text-foreground">&quot;Digital Products&quot;</strong> refers to software, digital downloads, and other non-physical goods.</li>
              <li><strong className="text-foreground">&quot;SaaS Products&quot;</strong> refers to software-as-a-service subscriptions providing ongoing access to software.</li>
              <li><strong className="text-foreground">&quot;Physical Products&quot;</strong> refers to apparel and other tangible goods.</li>
              <li><strong className="text-foreground">&quot;Content&quot;</strong> refers to all materials, including but not limited to software, text, images, and designs.</li>
            </ul>
          </section>
          ...
          <section id="account">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Age Requirement:</strong> You must be at least 18 years of age to create an account and use the Services. By creating an account, you represent and warrant that you are at least 18 years old.
            </p>
            <p className="text-sm text-muted-foreground">
          ...
          {/* Section 4 */}
          <section id="products">
            <h2 className="text-xl font-semibold mb-4">4. Products and Services</h2>

            <h3 className="text-lg font-medium mb-3">4.1 Software Licenses</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2 mb-4">
              <li>Redistribute, sublicense, sell, or transfer the software to any third party.</li>
              <li>Reverse engineer, decompile, or disassemble the software.</li>
              <li>Remove or alter any proprietary notices or labels.</li>
              <li>Use the software for any unlawful purpose.</li>
            </ul>

            <h3 className="text-lg font-medium mb-3">4.2 SaaS Subscriptions</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">4.3 Apparel and Physical Products</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Sizing:</strong> All sizing information is approximate and provided as a general guide only. We recommend consulting our size guides before ordering. Sizing may vary between different product lines and manufacturers. We are not responsible for items that do not fit as expected if the sizing guide was not followed.
            </p>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Colors and Images:</strong> We make every effort to display accurate colors of our products. However, actual product colors may vary from images shown due to differences in monitor settings, screen resolutions, photography lighting, and manufacturing variations. Minor color variations are not considered defects.
            </p>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Care Instructions:</strong> All apparel products come with care instructions. You are responsible for following these instructions. Damage resulting from improper care, washing, or handling is not covered under our return or warranty policies.
            </p>
            <p className="text-sm text-muted-foreground">
              <strong className="text-foreground">Custom and Personalized Items:</strong> Custom or personalized products are made specifically for you and cannot be returned or exchanged unless they are defective or we made an error in production. Please review all customization details carefully before placing your order.
            </p>
          </section>

          {/* Section 5 - Free Services and Beta Features */}
          <section id="free-services">
            <h2 className="text-xl font-semibold mb-4">5. Free Services and Beta Features</h2>

            <h3 className="text-lg font-medium mb-3">5.1 Free Services</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">5.2 Beta and Experimental Features</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2 mb-4">
              <li>Contain bugs, errors, or other issues that may cause system failures or data loss</li>
              <li>Be modified, suspended, or discontinued at any time without notice</li>
              <li>Not be subject to the same security, performance, or availability standards as production features</li>
              <li>Be subject to additional terms and conditions</li>
            </ul>
            <p className="text-sm text-muted-foreground">
              <strong className="text-foreground">Use of Beta Features is entirely at your own risk.</strong> We strongly recommend maintaining backups of any data used with Beta Features. We shall have no liability for any data loss, damages, or other issues arising from your use of Beta Features.
            </p>
          </section>
          ...
          <section id="acceptable-use">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2 mb-4">
              ...
              <li>To transmit, or procure the sending of, any advertising or promotional material, including any &quot;junk mail,&quot; &quot;chain letter,&quot; &quot;spam,&quot; or any similar solicitation without our prior written consent</li>
              ...
              <li>To harass, abuse, threaten, or intimidate other users or any third party</li>
              <li>To upload, transmit, or distribute any malware, viruses, worms, Trojan horses, or other harmful code</li>
              <li>To attempt to gain unauthorized access to any portion of the Services, other accounts, computer systems, or networks</li>
              <li>To interfere with or disrupt the integrity or performance of the Services or the data contained therein</li>
              <li>To use any automated means (including bots, scrapers, or crawlers) to access the Services without our prior written permission</li>
              <li>To circumvent, disable, or otherwise interfere with any security-related features of the Services</li>
              <li>To resell, redistribute, or sublicense access to the Services without our prior written authorization</li>
              <li>To infringe upon the intellectual property rights, privacy rights, or other rights of any third party</li>
          ...
          <section id="user-content">
            ...
            <h3 className="text-lg font-medium mb-3">7.1 Your Content</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">7.2 License to Us</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">7.3 Your Responsibilities</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2 mb-4">
              ...
              <li>Your User Content does not violate any applicable law, regulation, or these Terms</li>
              <li>Your User Content does not infringe the intellectual property rights or other rights of any third party</li>
              <li>Your User Content does not contain any viruses, malware, or other harmful code</li>
            </ul>

            <h3 className="text-lg font-medium mb-3">7.4 Our Rights</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">7.5 No Liability for User Content</h3>
            <p className="text-sm text-muted-foreground">
          ...
          <section id="ordering">
            <h2 className="text-xl font-semibold mb-4">8. Online Ordering Process</h2>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <ol className="list-decimal list-inside text-sm text-muted-foreground space-y-2 mb-4">
              <li>Browse our products and select items you wish to purchase.</li>
              <li>Add selected items to your shopping cart.</li>
              <li>Review your cart contents, quantities, and prices.</li>
              <li>Proceed to checkout and enter your shipping and billing information.</li>
              <li>Select your preferred payment method.</li>
              <li>Review your complete order, including all items, prices, taxes, and shipping costs.</li>
              <li>Read and accept these Terms of Service by checking the required checkbox.</li>
              <li>Click &quot;Confirm Order&quot; or &quot;Place Order&quot; to submit your order.</li>
            </ol>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2 mb-4">
              <li>You can modify the contents of your shopping cart at any time before checkout.</li>
              <li>During checkout, you can review and edit your shipping address, billing information, and payment method.</li>
              <li>The order review page displays all order details, allowing you to verify everything before final submission.</li>
              <li>You can use your browser&apos;s back button to return to previous steps and make corrections.</li>
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2">
              <li>An immediate order confirmation email to the email address associated with your account.</li>
              <li>The confirmation includes: order number, itemized list of products, prices, applicable taxes, shipping address, and estimated delivery time (for physical products).</li>
              <li>For digital products and SaaS subscriptions, access information or download links will be provided in the confirmation or a subsequent email.</li>
            </ul>
          </section>

          {/* Section 9 */}
          <section id="pricing">
            <h2 className="text-xl font-semibold mb-4">9. Pricing and Payment</h2>
            <p className="text-sm text-muted-foreground mb-4">
          ...
          <section id="subscriptions">
            <h2 className="text-xl font-semibold mb-4">10. Subscription Terms</h2>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Billing Cycles:</strong> Subscriptions are billed in advance on a recurring basis (monthly or annually, as selected). Your subscription will automatically renew at the end of each billing period unless cancelled.
            </p>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Auto-Renewal:</strong> By subscribing, you authorize us to charge your payment method automatically at the start of each billing period. You may cancel auto-renewal at any time through your account settings.
            </p>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Cancellation:</strong> You may cancel your subscription at any time. Cancellation takes effect at the end of the current billing period. You will retain access until the end of your paid period.
            </p>
            <p className="text-sm text-muted-foreground">
              <strong className="text-foreground">Price Changes:</strong> We reserve the right to modify subscription prices. You will be notified of any price changes at least 30 days before they take effect. Continued use after price changes constitutes acceptance.
            </p>
          </section>

          {/* Section 11 */}
          <section id="refunds">
            <h2 className="text-xl font-semibold mb-4">11. Refund Policy</h2>

            <h3 className="text-lg font-medium mb-3">11.1 Digital Products</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">11.2 SaaS Subscriptions</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">11.3 Physical Products (Apparel)</h3>
            <p className="text-sm text-muted-foreground mb-4">
          ...
          <section id="liability">
            ...
            <h3 className="text-lg font-medium mb-3">13.1 Disclaimer of Warranties</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">13.2 Limitation of Damages</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">13.3 Maximum Liability</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">13.4 Assumption of Risk</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <h3 className="text-lg font-medium mb-3">13.5 Force Majeure</h3>
            <p className="text-sm text-muted-foreground">
          ...
          <section id="governing">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Language:</strong> These Terms are drafted in English. In the event of any discrepancy between this English version and any translation, the English version shall prevail.
            </p>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">EU Consumer Dispute Resolution:</strong> The European Commission provides an online dispute resolution platform at{" "}
              <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground transition-colors">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Severability:</strong> If any provision of these Terms is held to be invalid or unenforceable, such provision shall be struck and the remaining provisions shall remain in full force and effect.
            </p>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Entire Agreement:</strong> These Terms, together with our Privacy Policy and any other agreements expressly incorporated by reference herein, constitute the entire agreement between you and Helvety by Rubin concerning the Services. These Terms supersede all prior or contemporaneous communications, whether electronic, oral, or written, between you and us regarding the Services.
            </p>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">No Waiver:</strong> Our failure to enforce any right or provision of these Terms shall not constitute a waiver of such right or provision. Any waiver of any provision of these Terms will be effective only if in writing and signed by us.
            </p>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Assignment:</strong> You may not assign or transfer these Terms, by operation of law or otherwise, without our prior written consent. Any attempt by you to assign or transfer these Terms without such consent will be null and void. We may freely assign or transfer these Terms without restriction. Subject to the foregoing, these Terms will bind and inure to the benefit of the parties, their successors, and permitted assigns.
            </p>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Notices:</strong> Any notices or other communications provided by us under these Terms will be given: (i) via email to the email address associated with your account; or (ii) by posting to the Services. For notices made by email, the date of receipt will be deemed the date on which such notice is transmitted. You may give us notice by email to contact@helvety.com or by mail to our address listed in the Contact section.
            </p>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">Export Compliance:</strong> You agree to comply with all applicable export and re-export control laws and regulations, including the Swiss State Secretariat for Economic Affairs (SECO) regulations, the US Export Administration Regulations (EAR), and sanctions programs administered by relevant authorities. You may not download or use the Services if you are located in a country or region subject to comprehensive sanctions, or if you are on any government list of prohibited or restricted parties.
            </p>
            <p className="text-sm text-muted-foreground">
              <strong className="text-foreground">Headings:</strong> The section headings in these Terms are for convenience only and have no legal or contractual effect.
            </p>
          </section>
          ...
          <footer className="pt-8 border-t border-border">
            <p className="text-xs text-muted-foreground text-center">
              By using Helvety services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
            </p>
          </footer>
        </article>
      </div>
